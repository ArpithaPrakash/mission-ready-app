...
# Adjust imports to point to services
from app.services.JSON_TO_PDF.JSON_TO_DRAW_PDF import generate_draw_pdf, render_preview_pdf
from app.services.parse_conop import extract_text_from_pptx, parse_conop_sections

try:
    from app.services.generate_draw import generate_draw_for_conop
    GENERATE_DRAW_IMPORT_ERROR: Optional[Exception] = None
except Exception as exc:
    generate_draw_for_conop = None
    GENERATE_DRAW_IMPORT_ERROR = exc

logger = logging.getLogger(__name__)

router = APIRouter(prefix="/api/conops", tags=["conops"])
